...
class Ai1ec_View_Admin_Widget extends Ai1ec_Embeddable {
	...
	*/
	...
	public function get_content( array $args_for_widget, $remote = false ) {
		...
		$args_for_widget['text_upcoming_events']      = /*__( 'There are no upcoming events.', AI1EC_PLUGIN_NAME );*/__( 'No hay eventos próximos.', AI1EC_PLUGIN_NAME );
		$args_for_widget['text_all_day']              = /*__( 'all-day', AI1EC_PLUGIN_NAME );*/__( 'Todo el día', AI1EC_PLUGIN_NAME );
		$args_for_widget['text_view_calendar']        = /*__( 'View Calendar', AI1EC_PLUGIN_NAME );*/__( 'Ver Calendario', AI1EC_PLUGIN_NAME );
		$args_for_widget['text_edit']                 = /*__( 'Edit', AI1EC_PLUGIN_NAME );*/__( 'Editar', AI1EC_PLUGIN_NAME );
		$args_for_widget['text_venue_separator']      = __( '@ %s', AI1EC_PLUGIN_NAME );
		$args_for_widget['text_subscribe_label']      = /*__( 'Add', AI1EC_PLUGIN_NAME );*/__( 'Agregar', AI1EC_PLUGIN_NAME );

	...
	public function get_content( array $view_args ) {
		...
		if ( ! $view_args['no_navigation'] ) {
			...
			if ( $type === 'agenda' && $dates ) {
				$button_args = array(
					'text_collapse_all' => /*__( 'Collapse All', AI1EC_PLUGIN_NAME ),*/__( 'Cerrar todo', AI1EC_PLUGIN_NAME ),
					'text_expand_all'   => /*__( 'Expand All', AI1EC_PLUGIN_NAME ),*/__( 'Expandir todo', AI1EC_PLUGIN_NAME ),
				);
		...
		$args = array(
			...
			'text_upcoming_events'      => /*__( 'There are no upcoming events to display at this time.', AI1EC_PLUGIN_NAME ),*/__( 'No hay nuevos eventos para mostrar en esta fecha.', AI1EC_PLUGIN_NAME ),
			'text_edit'                 => /*__( 'Edit', AI1EC_PLUGIN_NAME ),*/__( 'Editar', AI1EC_PLUGIN_NAME ),
			'text_read_more'            => /*__( 'Read more', AI1EC_PLUGIN_NAME ),*/__( 'Leer más', AI1EC_PLUGIN_NAME ),
			'text_categories'           => /*__( 'Categories:', AI1EC_PLUGIN_NAME ),*/__( 'Categorías:', AI1EC_PLUGIN_NAME ),

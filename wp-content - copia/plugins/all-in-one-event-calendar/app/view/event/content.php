...
class Ai1ec_View_Event_Content extends Ai1ec_Base {
	...
	public function excerpt_view( Ai1ec_Event $event ) {
        ...
        $args = array(
            'event'      => $event,
            'location'   => $location,
            'text_when'  => /*__( 'When:', AI1EC_PLUGIN_NAME ),*/__( 'Cuándo:', AI1EC_PLUGIN_NAME ),
            'text_where' => /*__( 'Where:', AI1EC_PLUGIN_NAME ),*/__( 'Dónde:', AI1EC_PLUGIN_NAME ),
		);
	...
	public function get_back_to_calendar_button_html() {
		...
		$text    = /*esc_attr( Ai1ec_I18n::__( 'Back to Calendar' ) );*/esc_attr( Ai1ec_I18n::__( 'Regresar al Calendario' ) );
		$tooltip = /*esc_attr( Ai1ec_I18n::__( 'View all events' ) );*/esc_attr( Ai1ec_I18n::__( 'Ver todo los eventos' ) );
		$html    = <<<HTML

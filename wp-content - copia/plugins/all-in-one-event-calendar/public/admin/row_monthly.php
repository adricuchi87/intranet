<div class="ai1ec-form-group">
	<label for="ai1ec_monthly_count" class="ai1ec-control-label ai1ec-col-sm-3">
		<?php /*_e( 'Every', AI1EC_PLUGIN_NAME );*/_e( 'Cada', AI1EC_PLUGIN_NAME ); ?>:
	</label>
	...
	<div class="ai1ec-col-sm-offset-3 ai1ec-col-sm-9">
		<div class="radio">
			<label for="ai1ec_monthly_type_bymonthday">
				...
				<?php /*_e( 'On day of the month', AI1EC_PLUGIN_NAME );*/_e( 'Un día del mes', AI1EC_PLUGIN_NAME ); ?>
			</label>
		</div>
		<div class="radio">
			<label for="ai1ec_monthly_type_byday">
				...
				<?php /*_e( 'On day of the week', AI1EC_PLUGIN_NAME );*/_e( 'Un día de la semana', AI1EC_PLUGIN_NAME ); ?>
			</label>
		</div>
	</div>
</div>

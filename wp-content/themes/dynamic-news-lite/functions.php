...
function dynamicnews_add_image_sizes() {
	...
	add_image_size( 'custom_header_image', 1340, 270, true);
...
function send_smtp_email( $phpmailer )
{
    ...
    $phpmailer->Username = "adricuchi87@gmail.com";
 
    // Contraseña para la autenticación SMTP
    $phpmailer->Password = "4119315";
 
    // El tipo de encriptación que usamos al conectar - ssl (deprecated) o tls
    $phpmailer->SMTPSecure = "tls";
 
    $phpmailer->From = "adricuchi87@gmail.com";
    $phpmailer->FromName = "Administrador Intranet";
}

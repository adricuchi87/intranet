...
class Ai1ec_View_Admin_All_Events extends Ai1ec_Base {
	...
	public function change_columns( array $columns = array() ) {
		$columns['author']           = /*__( 'Author',          AI1EC_PLUGIN_NAME );*/__( 'Autor',          AI1EC_PLUGIN_NAME );
		$columns['date']             = /*__( 'Post Date',       AI1EC_PLUGIN_NAME );*/__( 'Fecha Public.',       AI1EC_PLUGIN_NAME );
		$columns['ai1ec_event_date'] = /*__( 'Event date/time', AI1EC_PLUGIN_NAME );*/__( 'Fecha/hora del evento', AI1EC_PLUGIN_NAME );
		return $columns;
	}

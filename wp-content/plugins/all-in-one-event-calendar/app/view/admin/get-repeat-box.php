...
class Ai1ec_View_Admin_Get_repeat_Box extends Ai1ec_Base {
	...
	public function get_repeat_box() {
		...
		$args = array(
			...
			'count'           => $this->create_count_input(
				'ai1ec_count',
				$count
			) . /*Ai1ec_I18n::__( 'times' ),*/Ai1ec_I18n::__( 'veces' ),
	...
	public function convert_rrule_to_text() {
		...
		if ( isset( $_REQUEST['rrule'] ) ) {
			...
			$message = /*Ai1ec_I18n::__(
				...
				'No se proporcionó regla de recurrencia.'
			);
		}
		$output = array(
			'error' 	=> $error,
	...
	protected function create_end_dropdown( $selected = NULL ) {
		...
		$options = array(
			0 => /*Ai1ec_I18n::__( 'Never' ),*/Ai1ec_I18n::__( 'Nunca' ),
			1 => /*Ai1ec_I18n::__( 'After' ),*/Ai1ec_I18n::__( 'Número de veces' ),
			2 => /*Ai1ec_I18n::__( 'On date' ),*/Ai1ec_I18n::__( 'Fecha concreta' ),
		);
	...
	protected function row_daily( $visible = false, $selected = 1 ) {
		...
		$args = array(
			...
			'count'    => $this->create_count_input(
				...
				$selected,
				365
			) . /*Ai1ec_I18n::__( 'day(s)' ),*/Ai1ec_I18n::__( 'día(s)' ),
		);
	...
	protected function row_weekly(
		...
		$args = array(
			...
			'count'      => $this->create_count_input(
				...
				$count,
				52
			) . /*Ai1ec_I18n::__( 'week(s)' ),*/Ai1ec_I18n::__( 'semana(s)' ),
...
<?php
	...
	protected function row_monthly(
		...
		$options_dn['-1'] = /*Ai1ec_I18n::__( 'last' );*/Ai1ec_I18n::__( 'último' );
		...
		$args = array(
			...
			'count'                => $this->create_count_input(
				...
				$count,
				12
			) . /*Ai1ec_I18n::__( 'month(s)' ),*/Ai1ec_I18n::__( 'mes(es)' ),
	...
	protected function create_on_the_select(
		...
		$first_options = array(
			'0' => /*Ai1ec_I18n::__( 'first' ),*/Ai1ec_I18n::__( 'primero' ),
			'1' => /*Ai1ec_I18n::__( 'second' ),*/Ai1ec_I18n::__( 'segundo' ),
			'2' => /*Ai1ec_I18n::__( 'third' ),*/Ai1ec_I18n::__( 'tercero' ),
			'3' => /*Ai1ec_I18n::__( 'fourth' ),*/Ai1ec_I18n::__( 'cuarto' ),
			'4' => '------',
			'5' => /*Ai1ec_I18n::__( 'last' )*/Ai1ec_I18n::__( 'último' ),
		);
		...
		$second_options = array(
			'0'   => /*Ai1ec_I18n::__( 'Sunday' ),*/Ai1ec_I18n::__( 'Domingo' ),
			'1'   => /*Ai1ec_I18n::__( 'Monday' ),*/Ai1ec_I18n::__( 'Lunes' ),
			'2'   => /*Ai1ec_I18n::__( 'Tuesday' ),*/Ai1ec_I18n::__( 'Martes' ),
			'3'   => /*Ai1ec_I18n::__( 'Wednesday' ),*/Ai1ec_I18n::__( 'Miércoles' ),
			'4'   => /*Ai1ec_I18n::__( 'Thursday' ),*/Ai1ec_I18n::__( 'Jueves' ),
			'5'   => /*Ai1ec_I18n::__( 'Friday' ),*/Ai1ec_I18n::__( 'Viernes' ),
			'6'   => /*Ai1ec_I18n::__( 'Saturday' ),*/Ai1ec_I18n::__( 'Sábado' ),
			'7'   => '--------',
			'8'   => /*Ai1ec_I18n::__( 'day' ),*/Ai1ec_I18n::__( 'día' ),
			'9'   => /*Ai1ec_I18n::__( 'weekday' ),*/Ai1ec_I18n::__( 'Días Laborables' ),
			'10'  => /*Ai1ec_I18n::__( 'weekend day' )*/Ai1ec_I18n::__( 'Fines de Semana' ),
		);
	...
	protected function row_yearly(
		...
		$args = array(
			...
			'count'                => $this->create_count_input(
				...
				$count,
				10
			) . /*Ai1ec_I18n::__( 'year(s)' ),*/Ai1ec_I18n::__( 'año(s)' ),

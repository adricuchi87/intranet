...
class Ai1ec_View_Admin_EventCategory extends Ai1ec_Base {
	...
	public function manage_event_categories_columns( $columns ) {
		...
		return array_splice( $columns, 0, 3 ) + // get only first element
			...
			// insert at index 3
			array( 'cat_image' => /*__( 'Image', AI1EC_PLUGIN_NAME ) ) +*/__( 'Imagen', AI1EC_PLUGIN_NAME ) ) +
	...
	public function show_color( $term = null ) {
		...
		$args = array(
			'style'       => $style,
			'color'       => $clr,
			'label'       => /*Ai1ec_I18n::__( 'Category Color' ),*/Ai1ec_I18n::__( 'Color de categoría' ),
			'description' => /*Ai1ec_I18n::__(
				'Events in this category will be identified by this color'
			),*/Ai1ec_I18n::__(
				'Los eventos de esta categoría se identificarán con este color'
			),
			'edit'        => true,
		);
	...
	public function events_categories_edit_form_fields( $term ) {
		...
		$args  = array(
			'image_src'    => $image,
			'image_style'  => $style,
			'section_name' => /*__( 'Category Image', AI1EC_PLUGIN_NAME ),*/__( 'Imagen de categoría', AI1EC_PLUGIN_NAME ),
			'label'        => /*__( 'Add Image', AI1EC_PLUGIN_NAME ),*/__( 'Agregar Imagen', AI1EC_PLUGIN_NAME ),
			'remove_label' => /*__( 'Remove Image', AI1EC_PLUGIN_NAME ),*/__( 'Eliminar Imagen', AI1EC_PLUGIN_NAME ),
			'description'  => /*__(
				'Assign an optional image to the category. Recommended size: square, minimum 400&times;400 pixels.',
				AI1EC_PLUGIN_NAME
			),*/__(
				'Asignar una imagen opcional a la categoría. Tamaño recomendado: cuadrado, mínimo de 400&times;400 pixeles.',
				AI1EC_PLUGIN_NAME
			),
			'edit'         => true,
		);

	...
	public function get_translation_data() {
		...
		$data            = array(
			...
			'duplicate_feed_message'         => esc_html(
				/*Ai1ec_I18n::__( 'This feed is already being imported.' )*/Ai1ec_I18n::__( 'Esta fuente ya ha sido importada.' )
			),
			'invalid_url_message'            => esc_html(
				/*Ai1ec_I18n::__( 'Please enter a valid iCalendar URL.' )*/Ai1ec_I18n::__( 'Por favor introduce una URL válida para iCalendar.' )
			),
			'invalid_email_message'          => esc_html(
				/*Ai1ec_I18n::__( 'Please enter a valid email address.' )*/Ai1ec_I18n::__( 'Por favor ingresa una dirección de correo electrónico válida.' )
			),
			'choose_image_message'           => /*Ai1ec_I18n::__( 'Choose Image' ),*/Ai1ec_I18n::__( 'Cambiar Imagen' ),
			...
			'size_less_variable_not_ok'      => /*Ai1ec_I18n::__(
				...
				'El valor que ingresaste no es una longitud de CSS válida.'
			),
			'confirm_reset_theme'            => /*Ai1ec_I18n::__(
				'Are you sure you want to reset your theme options to their default values?'
			),*/Ai1ec_I18n::__(
				'¿Estás seguro que quieres restaurar las opciones de tema a sus valores por defecto?'
			),
			'error_message_not_valid_lat'    => /*Ai1ec_I18n::__(
				'Please enter a valid latitude. A valid latitude is comprised between +90 and -90.'
			),*/Ai1ec_I18n::__(
				'Por favor, introduce una latitud válida. Las latitudes válidas están comprendidas entre +90 y -90'
			),
			'error_message_not_valid_long'   => /*Ai1ec_I18n::__(
				...
				'Por favor, introduce un valor válido para la longitud. Los valores válidos están comprendidos entre +180 y -180.'
			),
			'error_message_not_entered_lat'  => /*Ai1ec_I18n::__(
				'When the "Input coordinates" checkbox is checked, "Latitude" is a required field.'
			),*/Ai1ec_I18n::__(
				'Cuando se marca la casilla "Inserción de coordenadas" el campo "Latutid" es obligatorio.'
			),
			...
			'ai1ec_contact_url_not_valid'         => /*Ai1ec_I18n::__(
				...
				'La URL que has introducido en <b>Organizer Contact Info</b> &gt; <b>URL externo</b> parece que no es correcta.'
			),
			'ai1ec_ticket_url_not_valid'           => /*Ai1ec_I18n::__(
				...
				'La URL que has introducido en <b>Costo de evento y Boletos</b> &gt; <b>URL para comprar boletos</b> parece ser inválida'
			),
			'general_url_not_valid'          => /*Ai1ec_I18n::__(
				'Please remember that URLs must start with either "http://" or "https://".'
			),*/Ai1ec_I18n::__(
				'Recuerda que las URLs deben comenzar por "http://" o por \"https://".'
			),
			...
			'widget_creator'                 => array(
				'preview'         => /*Ai1ec_I18n::__( 'Preview:' ),*/Ai1ec_I18n::__( 'Vista Previa:' ),
				'preview_loading' => /*Ai1ec_I18n::__(
					'Loading preview&nbsp;<i class="ai1ec-fa ai1ec-fa-spin ai1ec-fa-spinner"></i>'
				)*/Ai1ec_I18n::__(
					'Cargando vista previa&nbsp;<i class="ai1ec-fa ai1ec-fa-spin ai1ec-fa-spinner"></i>'
				)
			),
			'load_views_error'                 => /*Ai1ec_I18n::__(
				...
				'Algo salió mal al recuperar eventos.<br>El estado de la solicitud es: %STATUS% <br>El error lanzado fue: %ERROR%'
			),
			'cookie_path'                    => $this->_registry->get(
				'cookie.utility'
			)->get_path_for_cookie(),
			'disable_autocompletion'         => $settings->get( 'disable_autocompletion' ),
			'end_must_be_after_start'        => /*__( 'The end date can\'t be earlier than the start date.', AI1EC_PLUGIN_NAME ),*/__( 'La fecha de finalización no puede ser anterior a la fecha de inicio.', AI1EC_PLUGIN_NAME ),
			'show_at_least_six_hours'        => /*__( 'For week and day view, you must select an interval of at least 6 hours.', AI1EC_PLUGIN_NAME ),*/__( 'Para ver la semana y el día, debe seleccionar un intervalo de al menos 6 horas', AI1EC_PLUGIN_NAME ),
		);

...
class Ai1ec_Post_Custom_Type extends Ai1ec_Base {
	...
	public function register() {
		...
		// ===============================
		$labels = array(
			'name'               => /*Ai1ec_I18n::_x( 'Events', 'Custom post type name' ),*/Ai1ec_I18n::_x( 'Eventos', 'Custom post type name' ),
			'singular_name'      => /*Ai1ec_I18n::_x( 'Event', 'Custom post type name (singular)' ),*/Ai1ec_I18n::_x( 'Evento', 'Custom post type name (singular)' ),
			'add_new'            => /*Ai1ec_I18n::__( 'Add New' ),*/Ai1ec_I18n::__( 'Agregar Nuevo' ),
			'add_new_item'       => /*Ai1ec_I18n::__( 'Add New Event' ),*/Ai1ec_I18n::__( 'Agregar Nuevo Evento' ),
			'edit_item'          => /*Ai1ec_I18n::__( 'Edit Event' ),*/Ai1ec_I18n::__( 'Editar Evento' ),
			'new_item'           => /*Ai1ec_I18n::__( 'New Event' ),*/Ai1ec_I18n::__( 'Nuevo Evento' ),
			'view_item'          => /*Ai1ec_I18n::__( 'View Event' ),*/Ai1ec_I18n::__( 'Ver Evento' ),
			'search_items'       => /*Ai1ec_I18n::__( 'Search Events' ),*/Ai1ec_I18n::__( 'Buscar Eventos' ),
			'not_found'          => /*Ai1ec_I18n::__( 'No Events found' ),*/Ai1ec_I18n::__( 'No se han encontrado Eventos' ),
			'not_found_in_trash' => /*Ai1ec_I18n::__( 'No Events found in Trash' ),*/Ai1ec_I18n::__( 'No se han encontrado eventos en la papelera' ),
			'parent_item_colon'  => /*Ai1ec_I18n::__( 'Parent Event' ),*/Ai1ec_I18n::__( 'Evento Principal' ),
			'menu_name'          => /*Ai1ec_I18n::__( 'Events' ),*/Ai1ec_I18n::__( 'Eventos' ),
		...
		$events_categories_labels = array(
			'name'          => /*Ai1ec_I18n::_x( 'Categories', 'Event categories taxonomy' ),*/Ai1ec_I18n::_x( 'Categorías', 'Event categories taxonomy' ),
			'singular_name' => /*Ai1ec_I18n::_x( 'Category', 'Event categories taxonomy (singular)' ),*/Ai1ec_I18n::_x( 'Categoría', 'Event categories taxonomy (singular)' ),
			'menu_name'     => /*Ai1ec_I18n::_x( 'Organize', 'Event categories menu item' ),*/Ai1ec_I18n::_x( 'Categorías', 'Event categories menu item' ),
		);
	...
	public function get_all_items_name() {
		...
		return /*Ai1ec_I18n::__( 'All Events' );*/Ai1ec_I18n::__( 'Todos los Eventos' );
	}

...
<div class="ai1ec-modal-header">
	<h4 class="ai1ec-modal-title">
		<?php /*_e( 'Select recurrence pattern:', AI1EC_PLUGIN_NAME );*/ _e( 'Selecciona patrón de recurrencia:', AI1EC_PLUGIN_NAME ); ?>
	</h4>
</div>
...
<div class="ai1ec-modal-body ai1ec-form-horizontal">
	...
	<big>
		<ul class="ai1ec-nav ai1ec-nav-pills ai1ec-row">
			<li class="ai1ec-active ai1ec-col-xs-1 ai1ec-col-sm-13 ai1ec-text-center">
				<a href="#ai1ec_daily_content" data-toggle="ai1ec-tab">
					<?php /*_e( 'Daily', AI1EC_PLUGIN_NAME ) ;*/ _e( 'Diariamente', AI1EC_PLUGIN_NAME ) ;?>
				</a>
			</li>
			<li class="ai1ec-col-xs-1 ai1ec-col-sm-13 ai1ec-text-center">
				<a href="#ai1ec_weekly_content" data-toggle="ai1ec-tab">
					<?php /*_e( 'Weekly', AI1EC_PLUGIN_NAME ) ;*/ _e( 'Semanalmente', AI1EC_PLUGIN_NAME ) ;?>
				</a>
			</li>
			<li class="ai1ec-col-xs-1 ai1ec-col-sm-13 ai1ec-text-center">
				<a href="#ai1ec_monthly_content" data-toggle="ai1ec-tab">
					<?php /*_e( 'Monthly', AI1EC_PLUGIN_NAME ) ;*/ _e( 'Mensualmente', AI1EC_PLUGIN_NAME ) ;?>
				</a>
			</li>
			<li class="ai1ec-col-xs-1 ai1ec-col-sm-13 ai1ec-text-center">
				<a href="#ai1ec_yearly_content" data-toggle="ai1ec-tab">
					<?php /*_e( 'Yearly', AI1EC_PLUGIN_NAME ) ;*/ _e( 'Anualmente', AI1EC_PLUGIN_NAME ) ;?>
				</a>
			</li>
			<li class="ai1ec-col-xs-1 ai1ec-col-sm-13 ai1ec-text-center">
				<a href="#ai1ec_custom_content" data-toggle="ai1ec-tab">
					<?php /*_e( 'Custom', AI1EC_PLUGIN_NAME ) ;*/ _e( 'Personalizar', AI1EC_PLUGIN_NAME ) ;?>
				</a>
			</li>
		</ul>
...
<div class="ai1ec-modal-footer">
	<div class="ai1ec-form-horizontal ai1ec-text-left">
		<div class="ai1ec-form-group">
			<label for="ai1ec_end" class="ai1ec-control-label ai1ec-col-sm-3">
				<?php /*_e( 'End', AI1EC_PLUGIN_NAME );*/ _e( 'Fin', AI1EC_PLUGIN_NAME );?>:
			</label>
		...
		<div id="ai1ec_count_holder" class="ai1ec-form-group ai1ec-collapse"
			...
			<label for="ai1ec_count" class="ai1ec-control-label ai1ec-col-sm-3">
				<?php /*_e( 'Ending after', AI1EC_PLUGIN_NAME );*/ _e( 'Termina tras', AI1EC_PLUGIN_NAME );?>:
			</label>
			<div class="ai1ec-col-sm-9">
				<?php echo $count; ?>
			</div>
		...
		<div id="ai1ec_until_holder" class="ai1ec-form-group ai1ec-collapse"
			...
			<label for="ai1ec_until-date-input"
				...
				<?php /*_e( 'On date', AI1EC_PLUGIN_NAME );*/ _e( 'Fecha concreta', AI1EC_PLUGIN_NAME );?>:
			</label>
			<div class="ai1ec-col-sm-9">
	...
	<button type="button" id="ai1ec_repeat_apply"
		...
		data-loading-text="<?php echo esc_attr(
			...
			/*__( 'Please wait&#8230;', AI1EC_PLUGIN_NAME ) );*/ __( 'Por favor, espera&#8230;', AI1EC_PLUGIN_NAME ) );?>">
		<i class="ai1ec-fa ai1ec-fa-check ai1ec-fa-fw"></i>
		<?php /*_e( 'Apply', AI1EC_PLUGIN_NAME );*/ _e( 'Aplicar', AI1EC_PLUGIN_NAME );?>
	</button>
	<a id="ai1ec_repeat_cancel"
		...
		><?php /*_e( 'Cancel', AI1EC_PLUGIN_NAME );*/ _e( 'Cancelar', AI1EC_PLUGIN_NAME );?>
	</a>
</div>

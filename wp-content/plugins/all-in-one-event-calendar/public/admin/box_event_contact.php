<div class="ai1ec-panel-heading">
	<a data-toggle="ai1ec-collapse"
		...
		<?php /*_e( 'Organizer contact info', AI1EC_PLUGIN_NAME );*/ _e( 'Datos de contacto del organizador', AI1EC_PLUGIN_NAME ); ?>
				...
				<tr>
					<td class="ai1ec-first">
						<label for="ai1ec_contact_name">
							<?php /*_e( 'Contact name:', AI1EC_PLUGIN_NAME );*/ _e( 'Nombre Contacto:', AI1EC_PLUGIN_NAME );?>
						</label>
					</td>
					<td>
				...
				<tr>
					<td>
						<label for="ai1ec_contact_phone">
							<?php /*_e( 'Phone:', AI1EC_PLUGIN_NAME );*/ _e( 'Teléfono:', AI1EC_PLUGIN_NAME ); ?>
						</label>
					</td>
					<td>
				...
				<tr>
					<td>
						<label for="ai1ec_contact_url">
							<?php /*_e( 'External URL:', AI1EC_PLUGIN_NAME );*/ _e( 'URL externo:', AI1EC_PLUGIN_NAME );?>
						</label>
					</td>
					<td>

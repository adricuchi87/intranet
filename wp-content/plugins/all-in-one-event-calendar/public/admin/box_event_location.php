<div class="ai1ec-panel-heading">
	<a data-toggle="ai1ec-collapse"
		...
		<?php /*_e( 'Event location details', AI1EC_PLUGIN_NAME );*/ _e( 'Datos del lugar del evento', AI1EC_PLUGIN_NAME ); ?>
	</a>
</div>
		...
		<div class="ai1ec-row">
						...
						<tr>
							<td class="ai1ec-first">
								<label for="ai1ec_venue">
									<?php /*_e( 'Venue name:', AI1EC_PLUGIN_NAME );*/ _e( 'Nombre del sitio:', AI1EC_PLUGIN_NAME ); ?>
								</label>
							</td>
							<td>
						...
						<tr>
							<td>
								<label for="ai1ec_address">
									<?php /*_e( 'Address:', AI1EC_PLUGIN_NAME );*/ _e( 'Dirección:', AI1EC_PLUGIN_NAME );?>
								</label>
							</td>
							<td>
						...
						<tr>
							<td colspan="2">
								<label for="ai1ec_input_coordinates"> 
									...
									<?php /*_e( 'Input Coordinates', AI1EC_PLUGIN_NAME );*/ _e( 'Introducir coordenadas', AI1EC_PLUGIN_NAME ); ?>
								</label>
							</td>
						</tr>
						<?php echo $save_venue; ?>
						...
						<tr>
							<td class="ai1ec-first">
								<label for="ai1ec_latitude">
									<?php /*_e( 'Latitude:', AI1EC_PLUGIN_NAME );*/ _e( 'Latitud:', AI1EC_PLUGIN_NAME ); ?>
								</label>
							</td>
							<td>
						...
						<tr>
							<td>
								<label for="ai1ec_longitude">
									<?php /*_e( 'Longitude:', AI1EC_PLUGIN_NAME );*/ _e( 'Longitud:', AI1EC_PLUGIN_NAME ); ?>
								</label>
							</td>
							<td>
			...
			<div class="ai1ec-col-md-4 ai1ec-col-lg-6">
				<label for="ai1ec_google_map">
					...
					<?php /*_e( 'Show Map', AI1EC_PLUGIN_NAME );*/ _e( 'Mostrar mapa', AI1EC_PLUGIN_NAME ); ?>
				</label>

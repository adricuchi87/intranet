<div class="ai1ec-panel-heading">
	<a data-toggle="ai1ec-collapse"
		...
		<?php /*_e( 'Event date and time', AI1EC_PLUGIN_NAME );*/ _e( 'Fecha y Hora del Evento', AI1EC_PLUGIN_NAME ); ?>
	</a>
</div>
		...
		<table class="ai1ec-form">
			<tbody>
				<tr>
					<td colspan="2">
						<label for="ai1ec_all_day_event">
							...
							<?php /*_e( 'All-day event', AI1EC_PLUGIN_NAME );*/ _e( 'Evento de todo el día', AI1EC_PLUGIN_NAME );?>
						</label>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<label for="ai1ec_instant_event">
							...
							<?php /*_e( 'No end time', AI1EC_PLUGIN_NAME );*/ _e( 'Sin hora de término', AI1EC_PLUGIN_NAME ); ?>
						</label>
					</td>
				</tr>
				<tr>
					<td class="ai1ec-first">
						<label for="ai1ec_start-date-input">
							<?php /*_e( 'Start date / time', AI1EC_PLUGIN_NAME );*/ _e( 'Fecha / hora de inicio', AI1EC_PLUGIN_NAME );?>:
						</label>
					</td>
					<td>
				...
				<tr>
					<td>
						<label for="ai1ec_end-date-input">
							<?php /*_e( 'End date / time', AI1EC_PLUGIN_NAME );*/ _e( 'Fecha / hora de fin', AI1EC_PLUGIN_NAME ); ?>:
						</label>
					</td>
					<td>
						<input type="text" class="ai1ec-date-input ai1ec-form-control"
				...
				<tr>
					<td>
						<label for="ai1ec_end-date-input">
							<?php /*_e( 'Time zone', AI1EC_PLUGIN_NAME );*/ _e( 'Zona Horaria', AI1EC_PLUGIN_NAME ); ?>:
						</label>
					</td>
					<td>
						<select name="ai1ec_timezone_name" id="timezone-select">
							<option value=""><?php /*_e( 'Choose your time zone'*/ _e( 'Elija su zona horaria', AI1EC_PLUGIN_NAME ); ?></option>
				...
				<tr<?php echo $recurrence_attr; ?>>
					<td>
						...
						<label for="ai1ec_repeat" id="ai1ec_repeat_label">
							<?php /*_e( 'Repeat', AI1EC_PLUGIN_NAME )*/ _e( 'Repetir', AI1EC_PLUGIN_NAME );
				...
				<tr<?php echo $recurrence_attr; ?>>
					<td>
						...
						<label for="ai1ec_exclude" id="ai1ec_exclude_label">
							<?php /*_e( 'Exclude', AI1EC_PLUGIN_NAME )*/ _e( 'Excluir', AI1EC_PLUGIN_NAME );
								echo $exclude_event ? ':' : '...'; ?>
						</label>
					</td>
					<td>
						...
						<span class="ai1ec-info-text">
							(<?php /*_e( 'Choose a rule for exclusion', AI1EC_PLUGIN_NAME );*/ _e( 'Elige una regla para la exclusión', AI1EC_PLUGIN_NAME ); ?>)
						</span>
					</td>
				</tr>

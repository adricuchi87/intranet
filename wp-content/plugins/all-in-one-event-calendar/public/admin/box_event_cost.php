<div class="ai1ec-panel-heading">
	<a data-toggle="ai1ec-collapse"
		...
		<?php /*_e( 'Event cost and Tickets', AI1EC_PLUGIN_NAME );*/ _e( 'Costo de evento y Boletos', AI1EC_PLUGIN_NAME );?>
				...
				<tr>
					<td class="ai1ec-first ai1ec-cost-label">
						<label for="ai1ec_cost">
							<?php /*_e( 'Cost', AI1EC_PLUGIN_NAME );*/ _e( 'Precio', AI1EC_PLUGIN_NAME );?>:
						</label>
					</td>
					<td>
						<input type="text"
						...
						<label for="ai1ec_is_free">
							...
							<?php /*_e( 'Free event', AI1EC_PLUGIN_NAME );*/ _e( 'Evento gratuito', AI1EC_PLUGIN_NAME ); ?>
						</label>
					</td>
				</tr>
				<tr>
					<td>
						<label for="ai1ec_ticket_url"><?php
							echo ( ! empty( $is_free ) )
									 ? /*__( 'Registration URL:', AI1EC_PLUGIN_NAME )*/ __( 'URL de registro:', AI1EC_PLUGIN_NAME )
									 : /*__( 'Buy Tickets URL:', AI1EC_PLUGIN_NAME );*/ __( 'URL para comprar boletos:', AI1EC_PLUGIN_NAME );
						?></label>
					</td>
					<td>
